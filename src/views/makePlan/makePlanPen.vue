<template>
  <div>
    ...
    <el-main>
      ...
      <el-dialog v-model="addFormVisible" :visible.sync="addFormVisible" :close-on-click-modal="false" :append-to-body="true" width="20%" title="新增" @close="closeDialog" >
        <el-form ref="addForm" :model="addForm" :rules="addFormRules" label-width="80px">
          ...
          <el-form-item label="时间段">
            <el-select v-model="addForm.time" filterable clearable placeholder="请选择">
              <el-option
      ...
      <el-dialog v-model="editFormVisible" :visible.sync="editFormVisible" :close-on-click-modal="false" :append-to-body="true" width="20%" title="编辑">
        <el-form ref="editForm" :model="editForm" :rules="editFormRules" label-width="80px">
          ...
          <el-form-item label="时间段">
            <el-select v-model="editForm.plan_time_id" filterable clearable placeholder="请选择">
              <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
