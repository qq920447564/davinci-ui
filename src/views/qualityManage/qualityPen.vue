      ...
      <div>
        <el-form ref="form" :model="form" label-width="80px">
          <el-row :gutter="24">
            ...
            <el-button @click="addFormVisible = true">质量问题上报</el-button>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-dialog :visible.sync="dialogVisible" :before-close="handleClose" :append-to-body="true" title="删除提醒" width="30%">
